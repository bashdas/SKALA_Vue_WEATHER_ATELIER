...
<style scoped>
.weather-page{min-height:calc(100vh - 70px);padding:60px 24px 80px}.weather-dashboard{width:min(1080px,100%);margin:auto}.weather-section-heading{display:flex;align-items:end;justify-content:space-between;gap:20px;margin:38px 3px 16px}.weather-section-heading h2{margin:2px 0 0;color:var(--primary-900);font-size:24px;font-weight:700;letter-spacing:-.8px}.weather-section-heading>p{margin:0;color:#748194;font-size:12px}.eyebrow{margin:0;color:var(--primary-700);font-size:10px;font-weight:700;letter-spacing:1.4px}.weather-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:17px}.empty-message{padding:52px 24px;text-align:center;background:#fff;border:1px dashed var(--grey-200);border-radius:12px}.empty-message span{font-size:36px}.empty-message h3{margin:12px 0 5px}.empty-message p{margin:0;color:#748194}kbd{padding:2px 6px;background:#fff;border:1px solid var(--grey-200);border-bottom-width:2px;border-radius:4px}@media(max-width:800px){.weather-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:560px){.weather-page{padding:35px 16px}.weather-grid{grid-template-columns:1fr}.weather-section-heading{align-items:start;flex-direction:column}.weather-section-heading>p{line-height:1.8}}
</style>
