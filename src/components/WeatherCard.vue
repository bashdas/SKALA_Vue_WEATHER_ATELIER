...
<style scoped>
.weather-card{height:100%;min-height:330px;padding:23px;color:var(--primary-900);background:#fff;border:1px solid var(--grey-200);border-radius:12px;box-shadow:none;outline:none;transition:.18s ease}.weather-card:hover,.weather-card:focus-visible{transform:translateY(-3px);border-color:var(--primary-500);box-shadow:none}.weather-card:focus-visible{box-shadow:0 0 0 3px var(--primary-300)}.weather-card.selected{border-color:var(--primary-700);background:linear-gradient(160deg,#fff,var(--primary-100))}
.card-top{display:flex;justify-content:space-between}.city-name{margin:0;font-size:23px;font-weight:700;letter-spacing:-.7px}.weather-status{margin:5px 0 0;color:#3b5780;font-size:13px}.weather-icon{font-size:40px}.temperature{margin:21px 0 11px;font-size:47px;font-weight:750;letter-spacing:-2px}.temperature span{margin-left:3px;color:#3b5780;font-size:17px;font-weight:600}.temperature-label{display:inline-block;padding:6px 9px;font-size:12px;font-weight:700;border-radius:5px}.hot{color:#3b5780;background:#e6eaed}.cool{color:#3b5780;background:var(--primary-100)}
.mini-details{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin:20px 0 16px;padding-top:16px;border-top:1px solid #cdd6de}.mini-details div{padding:7px;background:#e6eaed;border-radius:7px}.mini-details dt{color:#3b5780;font-size:10px}.mini-details dd{margin:3px 0 0;font-size:13px;font-weight:750}.card-actions{display:flex;align-items:center;gap:3px}.card-actions :deep(.p-button){font-size:11px}.more-button{margin-left:auto}@media(min-width:700px){.more-button{display:none}}
</style>
